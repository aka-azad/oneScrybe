...
import CompetitorsTableData1 from './tables/CompetitorsTableData1';

const TableForCompetitors1 = () => {
  ...
  return (
    <Grid container spacing={4}>
      ...
      <Grid size={12}>
        <CompetitorsTableData1 apiRef={apiRef} filterButtonEl={filterButtonEl} />
      </Grid>
    </Grid>
  );
};

export default TableForCompetitors1;
