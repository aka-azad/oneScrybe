...
import CompetitorsTableData2 from './tables/CompetitorsTableData2';

const TableForCompetitors2 = () => {
  ...
  return (
    <Grid container spacing={4}>
      ...
      <Grid size={12}>
        <CompetitorsTableData2 apiRef={apiRef} filterButtonEl={filterButtonEl} />
      </Grid>
    </Grid>
  );
};

export default TableForCompetitors2;
