...
import MyContentTableData from './tables/MyContentTableData';

const TableForMyContent = () => {
  ...
  return (
    <Grid container spacing={4}>
      ...
      <Grid size={12}>
        <MyContentTableData apiRef={apiRef} filterButtonEl={filterButtonEl} />
      </Grid>
    </Grid>
  );
};

export default TableForMyContent;
